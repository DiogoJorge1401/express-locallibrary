...
let genres: any[] = []
let books: any[] = []
let bookinstances: any[] = []

type CB = (e: any, v: any) => void;

function authorCreate(first_name: string, family_name: string, d_birth: string | boolean, d_death: string | boolean, cb: CB) {
  const authordetail = { first_name: first_name, family_name: family_name } as any
...
function genreCreate(name: string, cb: CB) {
...
function bookCreate(title: string, summary: string, isbn: string, author: string, genre: any, cb: CB) {
  const bookdetail = {
    title: title,
    summary: summary,
    author: author,
...
function bookInstanceCreate(book: string, imprint: string, due_back: string | false, status: string | false, cb: CB) {
...
function createGenreAuthors(cb: CB) {
  async.series([
...
function createBookInstances(cb: CB) {
  async.parallel([
    function (callback: CB) {
